...
.PHONY: platform-preflight platform-manifest-plan platform-checks ns ns-check helm-repos metrics-server metrics-server-check aws-lbc aws-lbc-check kafka-namespace-check kafka-topics-check kafka-topic-naming-check kafka-config-check kafka-architecture-docs-check kafka-produce-consume-runbook-check kafka-validation-observability-check kafka-learning-notes-check kafka-metrics-boundary-check acs-ingest-heartbeat-schema-check acs-ingest-wan-status-schema-check acs-ingest-event-publisher-check acs-ingest-kafka-config-check acs-ingest-kafka-producer-check acs-ingest-publish-wiring-check acs-ingest-producer-retry-check acs-ingest-producer-observability-check acs-ingest-ingestion-metrics-check acs-ingest-unit-tests-check acs-ingest-kafka-producer-validation-check acs-ingest-kafka-producer-docs-check acs-ingest-kafka-producer-learning-notes-check cpemon-writer-kafka-consumer-config-check cpemon-writer-kafka-consumer-group-check cpemon-writer-heartbeat-subscription-check cpemon-writer-wan-status-subscription-check cpemon-writer-heartbeat-write-model-check cpemon-writer-wan-status-write-model-check cpemon-writer-event-processor-check cpemon-writer-offset-commit-check cpemon-writer-retry-deadletter-check cpemon-writer-consumer-lag-check cpemon-writer-processing-observability-check cpemon-writer-observability-story12-check cpemon-writer-consumer-unit-tests-check cpemon-writer-kafka-to-db-validation-check cpemon-api-kafka-status-validation-check cpemon-writer-kafka-consumer-operations-check cpemon-writer-kafka-consumer-learning-notes-check argocd-installation-check argocd-project-check argocd-gitops-layout-check argocd-cpemon-application-check argocd-kafka-application-check argocd-monitoring-application-check argocd-external-secrets-application-check argocd-policy-security-application-check argocd-sync-policy-check argocd-prune-self-heal-check argocd-gitops-deployment-validation-check argocd-drift-detection-check argocd-ci-cd-separation-check argocd-runbook-adr-interview-check argo-rollouts-controller-check monitoring-gitops-check cpemon-servicemonitor-check monitoring-template external-secrets-template kafka-chart-show kafka-template kafka kafka-check kafka-validate storage-check storage-gp3-plan storage-gp3-apply echo echo-check echo-port-forward echo-ingress echo-ingress-check netpol-check netpol-baseline-plan calico ingress pdb smoke helm-check helm-cpemon-lint helm-cpemon-template helm-cpemon-validate cpemon-api-db-check cpemon-writer-db-check cpemon-eso-render-check kafka-helm-workflow-check
