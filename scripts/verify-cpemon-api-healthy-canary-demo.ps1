...
Assert-Contains $runbookPath "CCPU-124"
Assert-Contains $runbookPath "promotion evidence checklist"
...
Assert-Contains $knowledgePath "CCPU-124: Create Successful Canary Demo"
...
Assert-Contains $interviewPath "Q56: What makes a successful canary demo convincing?"
